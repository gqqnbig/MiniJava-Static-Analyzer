...
public class ClassHierarchyAnalysis extends typeAnalysis.ClassHierarchyAnalysis
{
	protected HashMap<String, HashSet<Tuple<MethodSignature, Location>>> classCallSiteMapping;
